...
public class RegistrationPageConfirm extends javax.swing.JFrame {
    private Citizen tempCiti;
  
    public RegistrationPageConfirm(Citizen citi) {
        initComponents();
        this.tempCiti = citi;
    ...
    private RegistrationPageConfirm() {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        new RegistrationPage(tempCiti, false).show();
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrationPageConfirm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrationPageConfirm().setVisible(true);
            }
        });
    }
