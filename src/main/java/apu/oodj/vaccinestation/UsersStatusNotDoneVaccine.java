...
public class UsersStatusNotDoneVaccine extends javax.swing.JFrame {
     ...
     */
    public UsersStatusNotDoneVaccine(Citizen user) {
        initComponents();
        this.user = user;
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("You have not registered for any Vaccine!");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("Kindly click this button below to register yourself for a vaccine!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new UsersRegisterVaccine(this.user, false).show();
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsersStatusNotDoneVaccine(null).setVisible(true);
            }
        });
    }
